...
class Field:
    def __init__(self, size):
        ...
        if size == 'androsot':
            ...
            self.goal_area_length = 0.2
            self.goal_area_width = 1.4
            self.goal_height = 0.6
            self.circle_radius = 0.6
            self.border_strip_width = 0.2
        elif size == 'junior':
            self.size_y = 2.25
            self.size_x = 3
            self.penalty_mark_x = 1
            self.goal_area_length = 0.3
            self.goal_area_width = 2.5
            self.goal_height = 0.7
            self.circle_radius = 1
            self.border_strip_width = 0.3
        else:
            self.size_y = 2.25
            self.size_x = 3
            self.penalty_mark_x = 1.2
            self.goal_area_length = 0.5
            self.goal_area_width = 2.5
            self.circle_radius = 1
            self.border_strip_width = 0.3
            if size == 'kid':
        ...
        self.penalty_area_length = 1.2
        self.penalty_area_width = 3
