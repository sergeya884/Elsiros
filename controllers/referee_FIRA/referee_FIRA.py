...
children.importMFNodeFromString(-1, f'FIRA_Soccer_Field{{ size "{field_size}" }}')
children.importMFNodeFromString(-1, f'FIRA_Box_Obstacle {{ translation 1.4 0 0.15 }}')   #spawn FIRA obstacle
children.importMFNodeFromString(-1, f'FIRA_Box_Obstacle {{ translation 1.4 1.1 0.15 }}')   #spawn FIRA obstacle
children.importMFNodeFromString(-1, f'FIRA_Box_Obstacle {{ translation 1.4 -1.1 0.15 }}')   #spawn FIRA obstacle
children.importMFNodeFromString(-1, f'FIRA_Box_Obstacle {{ translation -1.4 0 0.15 }}')   #spawn FIRA obstacle
children.importMFNodeFromString(-1, f'FIRA_Box_Obstacle {{ translation -1.4 1.1 0.15 }}')   #spawn FIRA obstacle
children.importMFNodeFromString(-1, f'FIRA_Box_Obstacle {{ translation -1.4 -1.1 0.15 }}')   #spawn FIRA obstacle
