...
robot_coords = [1400, 1100, 45]  # Начальная позиция и угол
analyzer = RectangleAnalyzer(image_path=image_path, width=100, height=200, robot_coords=robot_coords, draw=False)
time_1 = time.time()
